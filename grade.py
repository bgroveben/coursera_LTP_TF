...
Precondition: gradefile begins with a header that contains no blank lines,
...
Return a list of int where each index indicates the number of grades in the following ranges:
